...
$proc = Start-Process powershell -ArgumentList @('-ExecutionPolicy','Bypass','-File',$scriptPath,'-BridgeRoot',$BridgeRoot) -RedirectStandardOutput $stdoutLog -RedirectStandardError $stderrLog -PassThru
